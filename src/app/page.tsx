              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5">
                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Login</a>
       ...
       <section className="mt-0 relative">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white p-8">
            ...
            <div className="flex space-x-4">
              <button className="bg-red-400 text-white px-6 py-2 rounded-full hover:bg-red-500 transition">
                Report disaster
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
          <div className="bg-gray-800 text-white p-8">
            <h3 className="text-2xl font-bold">3567K+</h3>
            <p className="text-gray-300">Demand of manpower is important in disaster situation</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
              <div className="bg-blue-500 p-3 rounded-md mr-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Annually, typhoons, strikes cause substantially affecting rural areas.</p>
              </div>
            </div>
            
            <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
              <div className="bg-red-300 p-3 rounded-md mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Get live updates on natural disasters, weather emergencies, and crisis situations near you.</p>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Natural disasters globally, causing 1% GDP decline and affecting millions of people.</p>
              </div>
            </div>
            
            <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
              <div className="bg-green-500 p-3 rounded-md mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Learn life-saving skills through workshops, modules, and specialized training sessions.</p>
              </div>
            </div>
            
            <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
              <div className="bg-purple-500 p-3 rounded-md mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">People have survived island-lives in Haiti, with Tamil Nadu being the hardest hit zone.</p>
              </div>
            </div>
            
            <div className="bg-white p-4 rounded-lg shadow-md flex items-start">
              <div className="bg-teal-400 p-3 rounded-md mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Connect with trained professionals and volunteers to rebuild and recover together.</p>
              </div>
            </div>
          </div>
        </div>
...
<footer className="bg-gray-800 text-white mt-12">
  <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li className="flex items-center">
            ...
            <span>Emergency Hotline: 1-800-DISASTER</span>
          </li>
          <li className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-red-400" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M5 4a3 3 0 00-3 3v10a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H5zm-1 9v-1h5v2H5a1 1 0 01-1-1zm7 1h4a1 1 0 001-1v-1h-5v2zm0-4h5V8h-5v2zM9 8H4v2h5V8z" clipRule="evenodd" />
            </svg>
            <span>Rescue Coordination: 1-888-RESCUE</span>
          </li>
          <li className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-red-400" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" />
            </svg>
            <span>Missing Persons: 1-877-FIND</span>
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li className="flex items-center">
            ...
            <span>support@disasterheroes.com</span>
          </li>
          <li className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li className="flex items-center">
            ...
            <span>Support Hotline: 1-866-HELP</span>
          </li>
        </ul>
      </div>
    ...
    <div className="border-t border-gray-700 mt-8 pt-8 text-center">
      <p>&copy; 2025 Disaster Heroes. All rights reserved.</p>
